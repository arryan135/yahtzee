...
const threeOfKind = new SumDistro({ count: 3 , description: "Sum all die if 3 are the same"});
const fourOfKind = new SumDistro({ count: 4 , description: "Sum all die of 4 are the same"});
